...
//const personalInfo = document.querySelectorAll('id');

document.getElementById('nickname').innerText = 'Sezar';
document.getElementById('fav-food').innerText = 'Icli Kofte';
document.getElementById('hometown').innerText = 'Istanbul';
